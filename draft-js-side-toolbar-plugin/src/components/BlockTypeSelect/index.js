    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <path
              d="M10.2143 21.2143V0.785714C10.2143 -0.261905 11.7857 -0.261905 11.7857 0.785714V21.2143C11.7857 22.2619 10.2143 22.2619 10.2143 21.2143ZM21.2143 11.7857H0.785714C-0.261905 11.7857 -0.261905 10.2143 0.785714 10.2143H21.2143C22.2619 10.2143 22.2619 11.7857 21.2143 11.7857Z"
              fill="#202641"
            />
          </svg>
        </div>
        ...
        */}
        {/* <div className={theme.blockTypeSelectStyles.spacer} /> */}
        {
          <div
            className={
              theme.blockTypeSelectStyles.inlineToolbar || 'inlineToolbar'
            }
            style={

...
export default class Toolbar extends React.Component {
  ...
  getStyle() {
    ...
    const currentSelectionContentBlocks = getSelectedBlocksList(
      store.getItem('getEditorState')()
    );
    const isHeading = currentSelectionContentBlocks.some(
      block => block.getType() === 'header-one'
    );
    const isVisible =
      (!isHeading && !selection.isCollapsed() && selection.getHasFocus()) ||
      overrideContent;
